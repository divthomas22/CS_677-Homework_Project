...
Use the Gaussian kernel SVM to predict the popularity of test data and colculate its accuracy. 
"""
import initial_analysis as ia
from sklearn.linear_model import LogisticRegression

# Use Gaussian kernel SVM classifier to predict class values for test data
